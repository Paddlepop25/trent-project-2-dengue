let eastSupermarkets = document
  .querySelector(".east-shopping")
  .addEventListener("click", () => {
    geteastShoppingMalls();
  });

function geteastShoppingMalls() {
...
function loadEastShoppingMallMarkers(googleData) {
